...
public class MarketProvider {
    ...
    public static void updateOfficers(MarketAPI market) {
        List<OfficerManagerEventSkillOverhaul> managers = SectorUtils.getListenerManager().getListeners(OfficerManagerEventSkillOverhaul.class);
        for (OfficerManagerEventSkillOverhaul manager : managers) {
