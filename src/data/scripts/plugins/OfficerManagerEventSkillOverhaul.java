 ...
 */
public class OfficerManagerEventSkillOverhaul extends BaseEventPlugin implements CallableEvent, ColonyInteractionListener, EveryFrameScript {
	...
	public static Logger log = Global.getLogger(OfficerManagerEventSkillOverhaul.class);
	...
	public OfficerManagerEventSkillOverhaul() {
		readResolve();
