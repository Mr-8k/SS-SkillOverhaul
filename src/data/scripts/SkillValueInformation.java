...
public class SkillValueInformation implements CustomSkillDescription {

    public static float TOOLTIP_WIDTH = 450;

    public static float FIGHTER_BAYS_THRESHOLD = Global.getSettings().getFloat("FIGHTER_BAYS_THRESHOLD");
    public static float OP_THRESHOLD = Global.getSettings().getFloat("OP_THRESHOLD");
    public static float OP_LOW_THRESHOLD = Global.getSettings().getFloat("OP_LOW_THRESHOLD");
    public static float OP_ALL_LOW_THRESHOLD = Global.getSettings().getFloat("OP_ALL_LOW_THRESHOLD");
    public static float PHASE_OP_THRESHOLD = Global.getSettings().getFloat("PHASE_OP_THRESHOLD");
    public static float MILITARIZED_OP_THRESHOLD = Global.getSettings().getFloat("MILITARIZED_OP_THRESHOLD");

    public static float AUTOMATED_POINTS_THRESHOLD = Global.getSettings().getFloat("AUTOMATED_POINTS_THRESHOLD");
...
//	float totalOP = SkillValueInformation.getTotalOP(fleet.getFleetData(), Global.getSector().getPlayerStats());
//	float phaseOP = SkillValueInformation.getPhaseOP(fleet.getFleetData(), Global.getSector().getPlayerStats());
    ...
    public FleetTotalItem getCombatOPTotal() {
        ...
        item.value = "" + (int) SkillValueInformation.getTotalCombatOP(fleet.getFleetData(), stats);
        item.sortOrder = 100;
    ...
    public FleetTotalItem getAutomatedPointsTotal() {
        ...
        item.value = "" + (int) SkillValueInformation.getAutomatedPoints(fleet.getFleetData(), stats);
        item.sortOrder = 350;
    ...
    public FleetTotalItem getPhaseOPTotal() {
        ...
        item.value = "" + (int) SkillValueInformation.getPhaseOP(fleet.getFleetData(), stats);
        item.sortOrder = 200;
    ...
    public FleetTotalItem getMilitarizedOPTotal() {
        ...
        item.value = "" + (int) SkillValueInformation.getMilitarizedOP(fleet.getFleetData(), stats);
        item.sortOrder = 300;
    ...
    public FleetTotalItem getFighterBaysTotal() {
        ...
        item.value = "" + (int) SkillValueInformation.getNumFighterBays(fleet.getFleetData());
        item.sortOrder = 400;
...
//	}
    ...
    public static List<FleetMemberPointContrib> getTotalOPDetail(FleetDataAPI data, MutableCharacterStatsAPI stats) {
        List<FleetMemberPointContrib> result = new ArrayList<SkillValueInformation.FleetMemberPointContrib>();
        for (FleetMemberAPI curr : data.getMembersListCopy()) {
            if (curr.isMothballed()) continue;
