...
public class PhaseCorpsSkillOverhaul {
...
//			addFighterBayThresholdInfo(info, data);
			...
			info.addPara("+%s seconds peak operating time for combat phase ships", 0f, hc, hc,
					//"" + (int) peakBonus,
					"" + (int) PEAK_TIME_BONUS);
			info.addPara("+%s top speed and acceleration while phase cloak active", 0f, hc, hc,
					//"" + (int) speedBonus + "%",
					"" + (int) PHASE_SPEED_BONUS + "%");
			info.addPara("+%s to sensor strength of combat phase ships*", 0f, hc, hc,
					//"" + (int) sensorBonus + "%",
