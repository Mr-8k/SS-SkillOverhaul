...
//	}
	...
	public static class Level3 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "- 0-flux speed boost is activated at any flux level, as long as the ship is not generating flux";
		}
	...
	public static class Level4 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "- 0-flux speed boost is activated at up to " + (int)(ZERO_FLUX_LEVEL) + "% flux";
		}
