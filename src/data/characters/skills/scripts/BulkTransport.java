...
public class BulkTransport {
	...
	public static float CARGO_CAPACITY_MAX_PERCENT = Global.getSettings().getFloat("CARGO_CAPACITY_MAX_PERCENT");
	public static float CARGO_CAPACITY_THRESHOLD = Global.getSettings().getFloat("CARGO_CAPACITY_THRESHOLD");

	public static float FUEL_CAPACITY_MAX_PERCENT = Global.getSettings().getFloat("FUEL_CAPACITY_MAX_PERCENT");
	public static float FUEL_CAPACITY_THRESHOLD = Global.getSettings().getFloat("FUEL_CAPACITY_THRESHOLD");

	public static float PERSONNEL_CAPACITY_MAX_PERCENT = Global.getSettings().getFloat("PERSONNEL_CAPACITY_MAX_PERCENT");
	public static float PERSONNEL_CAPACITY_THRESHOLD = Global.getSettings().getFloat("PERSONNEL_CAPACITY_THRESHOLD");

	public static float BURN_BONUS = Global.getSettings().getFloat("BURN_BONUS");
	...
	public abstract static class BaseCapacityModifierEffect extends SkillValueInformation implements ShipSkillEffect {
