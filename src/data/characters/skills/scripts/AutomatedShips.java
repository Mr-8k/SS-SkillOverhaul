...
public class AutomatedShips {
	...
	public static float MAX_CR_BONUS = Global.getSettings().getFloat("MAX_CR_BONUS");
	...
	public static class Level0 implements DescriptionSkillEffect {
		public String getString() {
			...
			if (SkillValueInformation.USE_RECOVERY_COST) {
				return(null) /*"*The total \"automated ship points\" are equal to the deployment recovery cost of " +
				...
				return(null) /*"*The total \"automated ship points\" are equal to the ordnance points of " +
...
/*			info.addPara("+%s combat readiness (maximum: %s)", 0f, hc, hc,
	...
	public static class Level2 extends SkillValueInformation implements CharacterStatsSkillEffect {
