...
public class PhaseCorps {
	...
	public static float FLUX_UPKEEP_REDUCTION = Global.getSettings().getFloat("FLUX_UPKEEP_REDUCTION");
	public static float PEAK_TIME_BONUS = Global.getSettings().getFloat("PEAK_TIME_BONUS");
	
	public static float PHASE_FIELD_BONUS_PERCENT = Global.getSettings().getFloat("PHASE_FIELD_BONUS_PERCENT");
...
//	}
	...
	public static class Level3 extends SkillValueInformation implements ShipSkillEffect, FleetTotalSource {
...
//			bonus = getThresholdBasedRoundedBonus(CAPACITY_PERCENT, op, FIGHTER_BAYS_THRESHOLD);
		...
		public void createCustomDescription(MutableCharacterStatsAPI stats, SkillSpecAPI skill, 
			...
			info.addPara("-%s flux generated by active phase cloak for combat phase ships", 0f, hc, hc,
					"" + (int) upkeepBonus + "%");
			
//			addFighterBayThresholdInfo(info, data);
//			info.addSpacer(5f);
			
			info.addPara("+%s seconds peak operating time for combat phase ships", 0f, hc, hc,
					"" + (int) peakBonus);
	...
	public static class Level4 extends SkillValueInformation implements FleetStatsSkillEffect {
